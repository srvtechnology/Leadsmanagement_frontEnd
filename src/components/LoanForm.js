...
function LoanForm(props) {
    ...
    const [emi, setemi] = useState(0); const [emi_amount, setemi_amount] = useState('');
    const [gst, setgst] = useState(null); const [gst_number, setgst_number] = useState('');
    ...
    const [loan_type, setloan_type] = useState(''); const [mobile, setmobile] = useState(''); const [pan, setpan] = useState('');
    ...
    function handleSubmit() {
        ...
        let data = {
            id: user.user_id, role: user.role, loan_id, emi, emi_amount, gst, gst_number, dsa, status, comment, tlstatus, application_no, lead_ref, bank_remark,
            salutation, fname, lname, office_city, loan_type, mobile, pan, dob, birth_place, aadhaar, aadhaar_linked_mobile,
        ...
        fetch(`${baseUrl}/api/lead-entry-loan`,
            {
                method: 'POST',
                body: formData
            })
            ...
            .then(res => {
                ...
                if (res.flag === 0) {
                    ...
                    setMsg(res.msg);
                    setmobile(''); setpan(''); setfname(''); setlname(''); setdob(''); setbirth_place(''); setaadhaar('');
                    ...
                    setemi(''); setemi_amount(''); setgst(''); setgst_number(''); dsa('');
                }
                ...
                <div className="container p-3">
                    ...
                    <div className="main-form row">
                        ...
                        <div className="mb-3 col-md-6 col-12">
                            ...
                            <select className="form-select" value={loan_type} onChange={(e) => setloan_type(e.target.value)}>
                                <option value="">Loan Type</option>
                                <option value="PERSONAL_LOAN">Personal Loan</option>
                                <option value="HOME_LOAN">Home Loan</option>
                                <option value="VEHICLE_LOAN">Vechicle Loan</option>
                                <option value="BUSSINESS_LOAN">Bussiness Loan</option>
                                <option value="MUDRA_LOAN">Mudra loan</option>
                                <option value="LAP_LOAN">LAP loan</option>
                        ...
                        <div className="mb-3 col-md-6 col-12">
                            ...
                            <select className="form-select" value={emi} onChange={(e) => setemi(e.target.value)}>
                                <option value="">Select</option>
                        ...
                        {emi == 1 ? <>
                            <div className="mb-3 col-md-6 col-12">
                                ...
                                <input type="text" className="form-control" value={emi_amount} onChange={(e) => setemi_amount(e.target.value)} />
                            </div>
                        </> : null}
                        <div className="mb-3 col-md-6 col-12">
                        ...
                        <div className="mb-3 col-md-6 col-12">
                            <label className="form-label">DSA /Franchise No</label>
                            <input type="text" className="form-control" value={dsa} onChange={(e) => setdsa(e.target.value)} />
                        </div>
                        <div className="mb-3 col-md-6 col-12">
                                ...
                                <>
                                    <div className="mb-3 col-md-6 col-12">
                                        ...
                                        <select className="form-select" value={status} onChange={(e) => setstatus(e.target.value)}>
                                            ...
                                            <option value="38">Disbursed</option>

                                        </select>
                                    </div>

                                    {status == 4 || status == 6 || status == 5 ? <>
                                        <div className="mb-3 col-md-6 col-12">
                                    ...
                                    <>
                                        ...
                                        <div className="mb-3 col-md-6 col-12">
                                            ...
                                            <select className="form-select" value={tlstatus} onChange={(e) => settlstatus(e.target.value)}>
                                                ...
                                                <option value="Reject">Loan Reject</option>
                                                {
                                                    status === 14 ? <>
