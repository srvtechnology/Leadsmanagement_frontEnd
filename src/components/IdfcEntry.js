...
function IdfcEntry(props) {
    ...
    useEffect(async () => {
        if (lead_id > 0) {
            ...
            let res = await fetch(`${baseUrl}/api/get-lead-idfc/${lead_id}`);
            res = await res.json();
            console.log(res)
    ...
    function handleSubmit() {
        ...
        fetch(`${baseUrl}/api/lead-entry-idfc`,
            {
                method: 'POST',
                body: formData,
            })
    ...
    function handleBack(e) {
        history.push("/idfc-summary")
    }
    return (
        <>
            <section style={{ marginTop: "100px" }}>
                <div className="container p-3">
                    <h1>IDFC Lead Entry</h1>
                    <hr />
                    <div className="main-form row">
                        <div className="mb-3 col-md-6 col-12">
                            ...
                            <select className="form-select" value={card_type} onChange={(e) => setcard_type(e.target.value)}>
                                ...
                                <option value="VISA_PLATINUM_CREDIT_CARD">IDFC Visa Platinum Credit Card</option>
                                <option value="SMART_VALUE_CREDIT_CARD">IDFC Smart Value Credit Card</option>
                                <option value="CASHBACK_CREDIT_CARD">IDFC Cashback Credit Card</option>
                                <option value="MASTERCARD_PREMIER_CREDIT_CARD">IDFC MasterCard Premier Credit Card</option>
