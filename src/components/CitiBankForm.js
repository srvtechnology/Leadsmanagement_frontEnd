...
function CitiBankForm(props) {
    ...
    useEffect(async () => {
        if (lead_id > 0) {
            ...
            setbank_doc_pass(res.lead.bank_pass); setsalary_slip_pass(res.lead.salary_pass); setpan_card_pass(res.lead.pan_pass); setaadhar_card_pass(res.lead.aadhar_pass);setother_doc_pass(res.lead.other_doc_pass);
            setpancard(res.lead.pan_card); setaadharcard(res.lead.aadhar_card);
            setotherDoc(JSON.parse(res.lead.other_doc));setsal_slip(JSON.parse(res.lead.salary_slip));
                ...
                <div className="container p-3">
                    ...
                    <div className="main-form row">
                        ...
                        <div className="mb-3 col-md-6 col-12">
                            ...
                            <input type="text" pattern="[1-9]{1}[0-9]{9}" className="form-control"  value={resi_phone} onChange={(e) => setresi_phone(e.target.value)} />
                        </div>
                        <div className="mb-3 col-md-6 col-12">
                            <label className="form-label">Mobile</label>
                            <input type="tel" maxLength="10" className="form-control" value={mobile} onChange={(e) => setmobile(e.target.value)} />
                        </div>
                        <div className="mb-3 col-md-6 col-12">
